...
from endpoint import getRinkebyEndpoint
...
w3 = Web3(Web3.HTTPProvider(getRinkebyEndpoint()))
...
def updateContracts():
	...
	print(gasPrice)
	#return
	transaction = appContract.functions.flipState().buildTransaction({'gas':200000,'gasPrice':w3.toWei('200','gwei'),'from':fromAddress,'nonce':nonce})
