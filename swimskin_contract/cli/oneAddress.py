...
def updateContracts():
	...
	transaction = appContract.functions.addAddresses(True, ["0x656a09216dbA49459745FABCC515e58dE7B14C0E"]).buildTransaction({'gas':5000000,'gasPrice':w3.toWei(gasPrice,'gwei'),'from':fromAddress,'nonce':nonce})
