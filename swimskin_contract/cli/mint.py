...
def updateContracts():
	...
	transaction = appContract.functions.mintNWD(1).buildTransaction({'value':w3.toWei('0.05','ether'),'gas':200000,'gasPrice':w3.toWei('120','gwei'),'from':fromAddress,'nonce':nonce})
